...
typedef bstptr_node_t      bstptr_stack_t;
typedef bstptr_node_t      bstptr_queue_t;
//=======================TYPEDEFS - END=======================
...
//defintion of instance of node of bst node pointer
struct bstptr_node
{
...
status_t pop_bstptr(bstptr_stack_t* p_bst_ptr_stack, bst_node_t** pp_bst_node);
...
bstptr_queue_t* create_queue(void);
...
status_t delete_bstptr(bstptr_queue_t* p_bst_ptr_queue, bst_node_t** pp_bst_node);
...
status_t get_bstptr_start(bstptr_list_t* p_bstptr_list, bstptr_node_t** pp_bst_node);
status_t get_bstptr_end(bstptr_list_t* p_bstptr_list, bstptr_node_t** pp_bst_node);
status_t pop_bstptr_start(bstptr_list_t* p_bstptr_list, bstptr_node_t** pp_bst_node);
status_t pop_bstptr_end(bstptr_list_t* p_bstptr_list, bstptr_node_t** pp_bst_node);
status_t is_bstptr_list_empty(bstptr_list_t* p_bstptr_list);
status_t destroy_bstptr_list(bstptr_list_t** pp_bst_list);
...
status_t remove_bst(bst_t* p_bst, data_t r_data)
{
    ...
    //case 1 = Left subtree of the z empty, right may or may not be empty
    ...
    else if(z-> right == NULL) //case 2 = left subtree is not null but right is null
    {
        if(z-> parent == NULL)
    ...
    else // Both subtrees are not null
    {
        ...
        //After getting out of while loop, u is now inorder successor of z
